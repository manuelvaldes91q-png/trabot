...
// We replace the two grids in the current index.html
content = content.replace(
    /<div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:3px;margin-bottom:3px">\s*<div><div class="lbl">Precio \$[\s\S]*?id="af_note"[\s\S]*?<\/div>\s*<\/div>/g,
    replacement
);
